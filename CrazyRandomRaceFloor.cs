...
namespace TrickyMultiplayerPlus
{
	...
	**/
    class CrazyRandomRaceFloor : ProRandomPuzzleFloor
	{
		public CrazyRandomRaceFloor(int seedIn, float heightIn, GameObject startParent = null) : base(seedIn, heightIn, startParent)
		{
			this.seed = seedIn;
